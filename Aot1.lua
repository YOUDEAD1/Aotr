...
local restoreButton = Instance.new("TextButton") -- زر الاستعادة
...
closeButton.MouseButton1Click:Connect(function()
    screenGui:Destroy() -- إزالة الواجهة بالكامل
end)
...
minimizeButton.MouseButton1Click:Connect(function()
    frame.Visible = false -- إخفاء الواجهة
    restoreButton.Visible = true -- إظهار زر الاستعادة
end)
...
restoreButton.BorderColor3 = Color3.fromRGB(0, 0, 0)
...
restoreButton.TextSize = 14.000
restoreButton.Visible = false -- مخفي في البداية

restoreButton.MouseButton1Click:Connect(function()
    frame.Visible = true -- إعادة إظهار الواجهة
    restoreButton.Visible = false -- إخفاء زر الاستعادة
end)
